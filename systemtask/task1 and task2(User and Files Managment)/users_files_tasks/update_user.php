...
$checkdata="UPDATE user_management set user_role='".$_POST['user_role']."',first_name='".$_POST['first_name']."',last_name='".$_POST['last_name']."',email_id='".$_POST['email_id']."',mobile_number='".$_POST['mobile_number']."',address='".$_POST['address']."',city='".$_POST['city']."',state='".$_POST['state']."',country='".$_POST['country']."' WHERE user_id='$user_id'";	
...
for(var i=0;i<document.getElementById('user_role').length;i++)
{
if(document.getElementById('user_role').options[i].value=="<?php echo $user_role; ?>")
{
document.getElementById('user_role').options[i].selected=true
}
}     
</script>
